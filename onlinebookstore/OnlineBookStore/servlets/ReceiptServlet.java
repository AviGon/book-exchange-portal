...
//			pw.println("<div class=\"tab\">You Successfully Paid for Following Books</div>");
			...
			while (rs.next()) {
				...
				String firstname=rs.getString(IBookConstants.COLUMN_FIRSTNAME);
				String phone=rs.getString(IBookConstants.COLUMN_PHONE);
				i = i + 1;
				...
				try {
					...
					if (bQty < quantity) {
						pw.println(
								"</table><div class=\"tab\">Quantity Exceeded!</div>");
						break;
					}
